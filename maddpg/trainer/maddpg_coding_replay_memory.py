...
class MADDPGAgentTrainer(AgentTrainer):
    ...
    def update(self, agents, episodes):
        ...
        #     return
        # self.replay_sample_index = self.replay_buffer.make_index(200)
        # #self.replay_sample_index = self.replay_buffer.make_index(len(self.replay_buffer))
        ...
        obs_n=episodes['observation']
        obs_next_n=episodes['observation_next']
        act_n=episodes['actions']

        obs=episodes['observation'][self.agent_index]
        act=episodes['actions'][self.agent_index]
        rew=episodes['reward'][self.agent_index]
